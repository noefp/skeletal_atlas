...
function get_expr_color(expr_val) {
  ...
  function load_image(canvas,kj_layer,imgs_group,img,img_x,img_y,img_w,img_h,sample_name,gene_expr,index) {
   

     var expr_color =[];
      expr_color=get_expr_color(gene_expr);
  ...
  function draw_gene_cartoons(canvas,imgObj,cartoons_all_genes,active_gene,index){
    ...
    load_image(canvas,kj_layer,imgs_group,img,img_x,img_y,img_w,img_h,sample_name,gene_expr,index);
