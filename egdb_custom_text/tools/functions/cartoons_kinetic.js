...
function get_expr_color(expr_val,ranges,colors) {
  ...
  function load_image(canvas,kj_layer,imgs_group,img,img_x,img_y,img_w,img_h,sample_name,gene_expr,index,ranges,colors) {
   
      // alert("load");
     var expr_color =[];
      expr_color=get_expr_color(gene_expr,ranges,colors);
  ...
  //define the canvas
  function create_canvas(canvas_h,canvas_w, myCanvas){
  ...
  function draw_gene_cartoons(canvas,imgObj,cartoons_all_genes,active_gene,index,ranges,colors){
    ...
    load_image(canvas,kj_layer,imgs_group,img,img_x,img_y,img_w,img_h,sample_name,gene_expr,index,ranges,colors);
