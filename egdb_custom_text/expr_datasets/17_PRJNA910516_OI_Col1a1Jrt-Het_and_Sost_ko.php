<p>
  Condition: Transcriptional analysis of the effects of deletion of Sclerostin gene in an Osteogenesis imperfecta mouse model
  Genotype: Col1a1Jrt/+ (OI model) and Col1a1Jrt/+;Sost-/- (OI model lacking of sclerostin gene)
...
<ul>
  <li>OI_Wt: Control mice (4 biological replicates, with 1 run each one).</li>
  <li>OI_Col1a1Jrt-Het: Mice suffering Osteogenesis Imperfecta, Col1a1Jrt/+ (4 biological replicates, with 1 run each one).</li>
  <li>OI_Col1a1Jrt-Het_SostKoOI: Mice suffering Osteogenesis imperfecta and lacking of Sclerostin (Sost) gene, Col1a1Jrt/+;Sost-/- (4 biological replicates, with 1 run each one).</li>
...
<p>
  This dataset was published by <a href="https://doi.org/10.1038/s41598-023-32221-3" target="_blank">Marulanda J et al., 2022</a> 
  and raw data can be found in the <a href="https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJNA910516" target="_blank">BioProject PRJNA910516</a>.
</p>
